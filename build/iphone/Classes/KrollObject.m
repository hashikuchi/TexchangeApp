...
//@interface TexchangeObject : NSObject
//@end

@interface TexchangeObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TexchangeObject class]])
		{
			for (NSString *key in [[(TexchangeObject*)o modules] allKeys])
			{
