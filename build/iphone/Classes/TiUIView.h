...
/**
 Base class for all Texchange views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Texchange view hierarchy (such as wrapped iOS UIViews) was touched.
