...
// in simulator we redefine to format for Texchange Developer console
...
{\
	NSString * exceptionName = [@"org.texchange." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.texchange";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UITexchangeNativeItemNone = -1, 
	UITexchangeNativeItemSpinner = -2,
	UITexchangeNativeItemProgressBar = -3,
	
	UITexchangeNativeItemSlider = -4,
	UITexchangeNativeItemSwitch = -5,
	UITexchangeNativeItemMultiButton = -6,
	UITexchangeNativeItemSegmented = -7,
	
	UITexchangeNativeItemTextView = -8,
	UITexchangeNativeItemTextField = -9,
	UITexchangeNativeItemSearchBar = -10,
	
	UITexchangeNativeItemPicker = -11,
	UITexchangeNativeItemDatePicker = -12,
	
	UITexchangeNativeItemInfoLight = -13,
	UITexchangeNativeItemInfoDark = -14,
	
	UITexchangeNativeItemDisclosure = -15,
	
	UITexchangeNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Texchange instances of
