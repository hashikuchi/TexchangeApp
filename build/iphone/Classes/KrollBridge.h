...
@interface TexchangeObject : KrollCoverageObject {
#else
@interface TexchangeObject : KrollObject {
#endif
@private
...
extern NSString * Texchange$ModuleRequireFormat;
